		...
		submitForm: function(settings, flg, url, ajaxPost, sync) {
			...
			if (flag) {
				...
				if (settings.ajaxPost || ajaxPost === "ajaxPost") {
					var ajaxsetup = $.extend({}, settings.ajaxpost || {});
					...
					$.each(dynamicAjaxData,function(i,e){
						_sendData[i] = e;
					});
					var localconfig = {
						type: "POST",
						async: true,
						data: $.extend(_sendData,  {}),
						...
						error: function(o) {
							settings.error && settings.error(o);
							o && catchAjaxError(o.readyState, o.status);
							curform[0].validform_status = "normal";
							curform[0].validform_ajax = null;
						}
					}
